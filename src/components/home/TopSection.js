...
export default function TopSection(props) {
    ...
    return ( <
        ...
        <
        LazyLoadImage className = "main-bg"
        src = { `${process.env.PUBLIC_URL}/assets/bg-main.png` }
        alt = "main-bg" /
        >
        <
        LazyLoadImage className = "dots-1"
        ...
        div className = "content-container" > {
            isMobile ? ( <
                ...
                fontWeight = "normal"
                fontSize = "20px" >
                تدکس لواسان - ٣۱اردیبهشت۱۴۰۰ <
                /Typography>

                <
                Typography margin = { "18px 0 43px 0" }
                color = "#B2B2B2"
                variant = "p"
                fontWeight = "300"
                fontSize = "16px" >
        ...
        /a> <
        div className = "link-to-speakers-container"
        ...
        لیست سخنران‌ها <
        /Typography> <
        LazyLoadImage className = "dots-2"
        ...
        <
        LazyLoadImage className = "arrow-down"
        src = { `${process.env.PUBLIC_URL}/assets/ic-arrow-down.svg` }
        alt = "arrow-down" /
        >
        <
        LazyLoadImage className = "chaos-h-link"
